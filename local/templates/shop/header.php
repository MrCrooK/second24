...
// check proOpt module install
if(!IsModuleInstalled('redsign.proopt')){
...
<?
?></head><?
?><body class="prop_option_<?=$prop_option?>"><?
			...
			?><div class="centering"><?
				?><div class="centeringin clearfix"><?
					...
					?><div class="callback column1 nowrap"><?
						?><div class="column1inner"><?
							?><a class="fancyajax fancybox.ajax" href="/nasvyazi/" title="<?=GetMessage("RSGOPRO.NA_SVYAZI_TITLE")?>"><?=GetMessage("RSGOPRO.NA_SVYAZI")?><i class="icon pngicons"></i></a><?
						?></div><?
					?></div><?
